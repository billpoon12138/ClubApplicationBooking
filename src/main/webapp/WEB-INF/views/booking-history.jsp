...
<html>
<h1>Search Booking Page</h1>
<form:form method="POST" modelAttribute="booking"
	action="${pageContext.request.contextPath}/booking/history">
		...
		<c:forEach var="booking" items="${bookingList}">
			<tr>
				...
				<td><a
					...
					<a
					href="${pageContext.request.contextPath}/booking/delete/${booking.bookingID}.html">Delete</a><br />
				</td>
			</tr>
		</c:forEach>
	</tbody>
